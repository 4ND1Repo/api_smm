...
class StockController extends Controller
{
    ...
    public function history_get(Request $r){
        ...
        // whole query
        $sup = Qty::selectRaw("stock.qty.stock_notes, stock.qty.nik, (convert(varchar, stock.qty.stock_date, 103) + ' ' + convert(varchar, stock.qty.stock_date, 24)) as stock_date, stock.qty.stock_price, master.master_supplier.supplier_name, stock.qty.main_stock_code, master.master_stock.*, master.master_measure.measure_type, (stock.qty.qty + CASE WHEN (
    ...
    public function history_out_get(Request $r){
        ...
        // whole query
        $sup = QtyOut::selectRaw("stock.qty_out.stock_notes, stock.qty_out.nik, (convert(varchar, stock.qty_out.stock_date, 103) + ' ' + convert(varchar, stock.qty_out.stock_date, 24)) AS stock_date, (convert(varchar, stock.qty_out.stock_out_date, 103) + ' ' + convert(varchar, stock.qty_out.stock_out_date, 24)) AS stock_out_date, stock.qty_out.stock_price, master.master_supplier.supplier_name, stock.qty_out.main_stock_code, master.master_stock.*, master.master_measure.measure_type, stock.qty_out.qty AS stock_qty")
